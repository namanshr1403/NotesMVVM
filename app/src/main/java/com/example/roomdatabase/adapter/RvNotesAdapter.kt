...
import com.example.roomdatabase.databinding.NoteItemLayoutBinding
import com.example.roomdatabase.fragments.NoteFragmentDirections
...
class RvNotesAdapter: ListAdapter<Note, RvNotesAdapter.NotesViewHolder>(DiffUtilCallback()) {
   ...
   inner class NotesViewHolder(itemView:View):RecyclerView.ViewHolder(itemView) {
       ...
       val markdown = Markwon.builder(itemView.context)
